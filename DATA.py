...
generate = {
    ...
    "journal" :" INSERT INTO journal (data_time , id_readers, id_books)"
                "select timestamp '2020-01-10 20:00:00' + random() * (timestamp '2014-01-20 20:00:00' -timestamp '2010-01-10 10:00:00'),"
               " id_readers, id_boooks  from readers TABLESAMPLE bernoulli(33), books TABLESAMPLE bernoulli(33) limit 1 ",


    "id_genry" :"INSERT INTO id_genry (genry) select chr(trunc(65 + random()*25)::int)|| chr(trunc(65 + random()*25)::int) || chr(trunc(65 + random()*25)::int)",

    "readers" :"INSERT INTO readers(name,surname,phone_number) select chr(trunc(65 + random()*25)::int)|| chr(trunc(65 + random()*25)::int)|| chr(trunc(65 + random()*25)::int),"
